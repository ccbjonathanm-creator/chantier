...
test("la PWA charge atomiquement les nouveaux fichiers du lot 2", () => {
  ...
  assert.match(index, /js\/documents\.js\?v=36/);
  assert.match(index, /js\/modules-gestion\.js\?v=36/);
  assert.match(sw, /chantier-v36/);
  assert.match(sw, /js\/documents\.js\?v=36/);
  assert.match(sw, /js\/modules-gestion\.js\?v=36/);
});
